...
Адреса при трансляции выставляются последовательно. Явно задать адрес, с которого будет записана команда/блок команд невозможно. Впрочем, все в Ваших руках. Исходный код открыт для редактирования.
